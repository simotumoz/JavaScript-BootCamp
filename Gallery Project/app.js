...
function Gallery(element){  //passing the section of our gallery

  this.container = element;

  this.list = [...element.querySelectorAll('.img')]; // from nodelist to array object
  ...
  /* this.openModal = this.openModal.bind(this); */ // binding to the gallery
  
  this.container.addEventListener('click', function(e)
  {
    if(e.target.classList.contains('img')){
      this.openModal(e.target, this.list); // points back to the container
    }

  }.bind(this) /* now it points to the gallery */);
